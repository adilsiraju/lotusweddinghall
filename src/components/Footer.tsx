        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1 md:col-span-1 lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/lotusweddingthalassery/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-lotus-gold transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                </svg>
              </a>
              <a href="https://www.instagram.com/lotusweddinghall" target="_blank" rel="noopener noreferrer" className="text-white hover:text-lotus-gold transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
              ...
              <a href="https://wa.me/919207102999" target="_blank" rel="noopener noreferrer" className="text-white hover:text-lotus-gold transition-colors">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li><a href="/packages" className="text-gray-300 hover:text-lotus-gold transition-colors">Wedding Ceremonies</a></li>
              <li><a href="/packages" className="text-gray-300 hover:text-lotus-gold transition-colors">Reception Parties</a></li>
              <li><a href="/packages" className="text-gray-300 hover:text-lotus-gold transition-colors">Corporate Events</a></li>
              <li><a href="/packages" className="text-gray-300 hover:text-lotus-gold transition-colors">Birthday Celebrations</a></li>
              <li><a href="/packages" className="text-gray-300 hover:text-lotus-gold transition-colors">Kerala Sadhya</a></li>
              <li><a href="/packages" className="text-gray-300 hover:text-lotus-gold transition-colors">Malabar Cuisine</a></li>
            </ul>
          </div>
