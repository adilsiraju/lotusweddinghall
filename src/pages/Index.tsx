          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <FeatureCard
              icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M20.4999 11.9999H22.9999M1 11.9999H3.5M11.9999 20.4999V22.9999M11.9999 1V3.5" stroke="#D4AF37" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>}
              title="Kerala Sadhya"
