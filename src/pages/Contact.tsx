              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Wedding Lane,<br />Kerala, India 682001</p>
                  </div>
                </div>
        ...
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-gray-600">
              Located conveniently in the heart of Kerala, just 15 minutes from the airport.
            </p>
          </div>
          
          <div className="rounded-lg overflow-hidden shadow-xl h-[500px]">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31371.15142513944!2d76.27422129156946!3d10.005945979247631!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b080d08f976f3a9%3A0xe9cdb444f06ed454!2sErnakulam%2C%20Kochi%2C%20Kerala!5e0!3m2!1sen!2sin!4v1606587281149!5m2!1sen!2sin" 
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 
              allowFullScreen 
